...
A simple and interactive project built with HTML, CSS, and JavaScript that allows users to generate random RGB colors for both a box element and the page background.
...
## ✨ Features
- Generate random RGB colors at the click of a button
- Change the box size, color, and styling dynamically
- Change the background color of the page
- Display the generated color values in real time
- Clean and simple UI
